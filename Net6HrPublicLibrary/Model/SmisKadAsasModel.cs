...
{
    public class SmisKadAsasModel
    {
        public string? REKODSET { set; get; }
        ...
        public string? KAD_SOKONG_NAMA { set; get; }
        public string? KAD_SOKONG_KODJAWATAN { set; get; }
        public string? KAD_SOKONG_KODPTJ { set; get; }
        public string? KAD_LULUS_NAMA { set; get; }
        public string? KAD_LULUS_KODJAWATAN { set; get; }
        public string? KAD_LULUS_KODPTJ { set; get; }
        public string? KAD_SELIA_NAMA { set; get; }
        public string? KAD_SELIA_KODJAWATAN { set; get; }
        public string? KAD_SELIA_KODPTJ { set; get; }
    }
}
